    ...
    <div className="max-w-7xl mx-auto p-4 md:p-6 min-h-[70vh]">
      ...
      {myProperties.length === 0 ? (
        <div className="bg-white p-10 rounded-xl shadow text-center border">
          ...
          <p className="text-gray-500 mb-6">Start adding your properties to reach thousands of buyers.</p>
        </div>
      ) : (
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center justify-between bg-gray-50 p-2 rounded border">
                    ...
                    <select 
                      ...
                      className={`text-sm font-bold border-none bg-transparent cursor-pointer focus:ring-0
                        ${item.status === 'available' ? 'text-green-600' : 
                          item.status === 'sold' ? 'text-red-600' : 'text-purple-600'}`}
                    >
                  ...
                  <div className="flex gap-2 mt-2">
                    <NavLink 
                      ...
                      className="flex-1 bg-blue-100 text-blue-700 text-center py-2 rounded font-semibold hover:bg-blue-200"
                    >
                      View
                    </NavLink>
                    <button 
                      onClick={() => handleDelete(item._id)}
                      className="flex-1 bg-red-100 text-red-700 text-center py-2 rounded font-semibold hover:bg-red-200"
                    >
                      Delete
                    </button>
                  </div>
