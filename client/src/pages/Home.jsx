...
//               <NavLink 
//                 to="/ownerlogin" 
//                 className="group inline-flex items-center gap-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold px-6 py-3 rounded-xl hover:from-green-600 hover:to-emerald-700 transition-all duration-200 shadow-md hover:shadow-lg"
//               >
//                 <span>List a Property</span>
//                 <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
//               </NavLink>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="group relative bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden">
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold mb-3 text-slate-900">Looking to Buy ?</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Browse our extensive collection of verified properties with detailed insights and virtual tours.
              </p>
              ...
              <NavLink 
                to="/properties" 
                className="group inline-flex items-center gap-2 bg-white text-green-600 border-2 border-blue-600 px-6 py-3 rounded-xl hover:bg-green-600 hover:text-white transition-all duration-200 font-bold shadow-md hover:shadow-lg"
              >
                <span>Browse Properties</span>
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </NavLink>
          ...
          {/* Sell/Lease Card - IMPROVED BUTTON VISIBILITY */}
          <div className="group relative bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-green-50 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-500"></div>
            ...
            <div className="relative">
              ...
              <NavLink 
                to="/ownerlogin" 
                className="group inline-flex items-center gap-2 bg-white text-green-600 border-2 border-green-600 px-6 py-3 rounded-xl hover:bg-green-600 hover:text-white transition-all duration-200 font-bold shadow-md hover:shadow-lg"
              >
                <span>List a Property</span>
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </NavLink>
