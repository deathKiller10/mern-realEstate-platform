  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-blue-900 bg-opacity-90 px-4">
      <div className="bg-white p-10 rounded-lg shadow-lg w-full max-w-sm">
        <h2 className="text-2xl font-bold text-center text-blue-900 mb-6">Property Owner Login</h2>
        ...
        <p className="text-center mt-6 text-sm">
          Don't have an account?{" "}
          <NavLink to="/ownerregister" className="text-green-500 font-bold hover:underline">
            Create New Account
          </NavLink>
        </p>
      </div>
